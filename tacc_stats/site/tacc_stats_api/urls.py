...
urlpatterns = patterns('',
                       url(r'^thresholds/(?P<resource_name>stampede|lonestar|maverick|wrangler)$', ThresholdList.as_view(), name='threshold_list'),
                       url(r'^thresholds/(?P<pk>\d+)/(?P<resource_name>stampede|lonestar|maverick|wrangler)$', ThresholdDetail.as_view(), name='threshold_detail'),
                       ...
                       url(r'^jobs/(?P<resource_name>stampede|lonestar|maverick|wrangler)$', cache_page(3600)(JobListView.as_view()), name='job_list'),
