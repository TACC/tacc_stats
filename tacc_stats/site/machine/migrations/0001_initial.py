...
import tacc_stats.site.machine.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', tacc_stats.site.machine.models.RealField(null=True)),
                ('arc', tacc_stats.site.machine.models.RealField(null=True)),
                ('delta', tacc_stats.site.machine.models.RealField(null=True)),
            ],
            options={
                'db_table': 'host_data',
            },
