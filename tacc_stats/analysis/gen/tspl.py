...
class TSPLBase:
  ...
  def __init__(self,file,k1,k2,job_data = None):
    ...
    elif 'intel_ivb' in self.j.hosts.values()[0].stats:
    ...
    elif 'intel_skx' in self.j.hosts.values()[0].stats:
      self.pmc_type='intel_skx'
    ...
    if isinstance(k1,dict) and isinstance(k2,dict):
      ...
      if not self.pmc_type in self.j.schemas:
