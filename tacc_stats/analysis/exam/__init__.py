...
from tacc_stats.analysis.exam.memusage import MemUsage
...
from tacc_stats.analysis.exam.packet_size import PacketSize
from tacc_stats.analysis.exam.lnet_packet_rate import LnetPacketRate
