...
static int intel_bdw_begin(struct stats_type *type)
{
  int n_pmcs = 0;
  int nr = 0;
...
static void intel_bdw_collect(struct stats_type *type)
{
  int i;
...
struct stats_type intel_bdw_stats_type = {
  .st_name = "intel_bdw",
  .st_begin = &intel_bdw_begin,
  .st_collect = &intel_bdw_collect,
#define X SCHEMA_DEF
