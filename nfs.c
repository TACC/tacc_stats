...
/* See fs/nfs/iostat.h and nfs_show_stats() in fs/nfs/super.c. */
...
/* FIXME Add U=P for page sized units. */
...
/* See xprt_rdma_print_stats() (net/sunrpc/xprtrdma/transport.c)
   xs_tcp_print_stats(), and xs_udp_print_stats()
   (net/sunrpc/xprtsock.c) and include/linux/sunrpc/xprt.h in the
...
static void nfs_collect_mnt_xprt(struct stats *stats, char *str)
{
  ...
  /* For UDP, skip port and bind_count.  For TCP, skip those,
     connect_count, connect_time, and idle_time. */
...
/* See struct rpc_iostats in include/linux/sunrpc/metrics.h and
   rpc_print_iostats() in net/sunrpc/stats.c. */
			   ...
			   char **p_line, size_t *p_line_size)
{
  ...
  while (1) {
    ...
    /*
      events: 86104644 8232551112 1009346 29773140 77713963 3396235...
      bytes:  4886067767364 671548484867 0 0 1268384471881 672425463273...
  ...
  /*
    per-op statistics
      ...
      GETATTR: 86102054 86103087 0 13515430340 9643670764...
    ...
  */
