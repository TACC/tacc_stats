...
and Python modules for particular computing platforms.  The configure file 
...
If the system is missing any `TYPES` that are left as True that type will automatically be skipped during the monitoring.
